export const profile = {
  ...
  photo: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=600",
  bio: [
  ...
  intro: "I help organizations make data-driven decisions through comprehensive analytics and strategic planning. Specialized in business intelligence, project management, and digital transformation."
};
...
export const projects = [
  {
    ...
    description: "A comprehensive dashboard providing real-time insights for a major retail chain, featuring sales analysis, inventory tracking, and customer behavior patterns.",
    image: "https://images.unsplash.com/photo-1543286386-713bdd548da4?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400",
  ...
  },
  {
    ...
    description: "Developed predictive models to forecast financial trends for investment firms, utilizing machine learning algorithms and time-series analysis.",
  ...
  },
  {
    ...
    category: "Business Intelligence",
    description: "Implemented an end-to-end supply chain optimization solution that reduced logistics costs by 23% and improved delivery times for a manufacturing client.",
  ...
  },
  {
    ...
    description: "Created a detailed customer segmentation model for a telecommunications company, enabling targeted marketing campaigns and improved customer retention strategies.",
  ...
  },
  {
    ...
    description: "Designed and developed an interactive market research platform allowing clients to visualize industry trends and competitor analysis in real-time.",
  ...
  },
  {
    ...
    category: "Machine Learning",
    description: "Built a predictive analytics system for healthcare providers to forecast patient admission rates and optimize staffing levels, improving resource allocation by 18%.",
